# Generated by Django 2.2 on 2022-04-04 19:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(choices=[(0, '普通用户'), (1, '管理员')], default=0, verbose_name='用户等级')),
            ],
            options={
                'verbose_name': '用户信息',
                'db_table': 'user_info',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='summertestuser.UserInfo')),
            ],
            options={

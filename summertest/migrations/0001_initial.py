# Generated by Django 2.2 on 2022-04-04 19:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yapi_base_url', models.CharField(blank=True, default='', max_length=100, verbose_name='yapi openapi的url')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='summertest.Project')),
            ],
            options={
                'verbose_name': '测试报告',
                'db_table': 'report',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.OneToOneField(db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='summertest.Report')),
            ],
            options={
                'verbose_name': '测试报告详情',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.OneToOneField(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='summertest.Project')),
            ],
            options={
                'verbose_name': '驱动库',
                'db_table': 'debugtalk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='summertest.Case')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='case',
            name='project',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='summertest.Project'),
        ),
        migrations.CreateModel(
            name='API',
            fields=[
